...
public class LightningsGeneratorTest {
    private static LightningsGenerator lightningsGenerator;
    ...
    static void setUp() {
        ...
        lightningsGenerator = new LightningsGenerator(forecasts, lightningsConfigurator);
    }

    @Test
    void testGetPerfectDay() {
        assertEquals(lightningsGenerator.getPerfectDay(), 1, 0,
            "The TemperatureGenerator must correctly find prefect day!");
    }

    @Test
    void testGetPerfectDayNoSuch() {
        LightningsGenerator lightningsGenerator1 =
            new LightningsGenerator(forecasts, LightningsConfigurator.builder()
                .setLightnings(true)
                .build());
